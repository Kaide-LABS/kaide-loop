...
**Install path (2026-08-06):** see `docs/mcp-setup.md` for verified setup of all three servers. That doc also corrects arXiv MCP's license label above from MIT to its actual Apache-2.0 (still free/permissive; conclusion below unaffected).
